...
<div id="page">
    ...
    <div class="header header-fixed header-logo-center">
        <a href="index.html" class="header-title">Guten Morgen, {{ Auth::user()->vorname }}</a>
    ...
    <div id="footer-bar" class="footer-bar-1">
        ...
        <a href="index-pages.html" class="active-nav"><i class="fa fa-heart"></i><span>Tagebuch</span></a>
